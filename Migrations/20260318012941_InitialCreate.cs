        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "text", nullable: false),
                    Bio = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    ...
                    CiudadPais = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StarTime = table.Column<TimeOnly>(type: "time without time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DurationOptions = table.Column<List<int>>(type: "integer[]", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TutorProfileTutorId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
