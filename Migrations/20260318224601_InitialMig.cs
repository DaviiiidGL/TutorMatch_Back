        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CiudadPais = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Availabilities_TutorProfiles_TutorProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DurationOptions = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Offers_TutorProfiles_TutorProfileId",
                        column: x => x.TutorProfileId,
                        principalTable: "TutorProfiles",
                        principalColumn: "TutorId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TutorProfileTutorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reviews", x => x.ReviewId);
                    table.ForeignKey(
                        name: "FK_Reviews_TutorProfiles_TutorProfileTutorId",
                        column: x => x.TutorProfileTutorId,
                        principalTable: "TutorProfiles",
                        principalColumn: "TutorId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Availabilities_TutorProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversations_TutorProfileId",
                table: "Conversations",
                column: "TutorProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Offers_TutorProfileId",
                table: "Offers",
                column: "TutorProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_Reviews_TutorProfileTutorId",
                table: "Reviews",
                column: "TutorProfileTutorId");
